...
#define MFRC522_CS(x) x ? GPIO_SetBits(GPIOD,GPIO_Pin_6):GPIO_ResetBits(GPIOD,GPIO_Pin_6)
#define MFRC522_Rst(x) x ? GPIO_SetBits(GPIOC,GPIO_Pin_11):GPIO_ResetBits(GPIOC,GPIO_Pin_11)
/////////////////////////////////////////////////////////////////////
//MF522命令字
/////////////////////////////////////////////////////////////////////
...
//MFRC522各个引脚的宏定义
#define MFRC522_MISO 			PCin(8)
#define MFRC522_MOSI			PCout(6)
#define MFRC522_SCK				PDout(7)
#define MFRC522_RST 			PCout(11)
